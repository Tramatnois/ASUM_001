 ...
 * @author tramatnois
 */
public class FXML_InspResults_DocumentController extends AnchorPane {

    @FXML
    private JFXTreeTableView<InspectionResultDTO> tbl_view_inspResults;
     ...
     */
    public synchronized static FXML_InspResults_DocumentController getInstance() {
        if (instance == null) {
            instance = new FXML_InspResults_DocumentController();
        }
        return instance;
    }
     ...
     */
    private FXML_InspResults_DocumentController() {
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/mvc_view_application/FXML_InspResults_Document.fxml"));
